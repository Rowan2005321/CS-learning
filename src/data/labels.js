export const labels = {
  en: {
    ...
    authCodeSent: "Verification code sent to {email}. Enter it below to finish creating your account.",
    ...
    authGuardTitle: "Sign in to open your personal study log",
    authGuardText:
      "Your study log is personal data. Please sign in or create an account first.",
    ...
    emailCodeHint:
      "Use the one-time code from your email. This avoids broken confirmation links.",
  ...
  zh: {
    ...
    authGuardTitle: "请先登录后再打开个人学习记录",
    authGuardText: "学习记录属于个人数据，请先登录或注册账号。",
